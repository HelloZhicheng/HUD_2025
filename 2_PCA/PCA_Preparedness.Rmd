---
title: "PCA Adaptivity Preparedness Analysis"
---
...
all_data <- cbind(Social[,-c(1:5)], Eco[,-c(1:5)])
...
raw_loadings <- pca_all$rotation[, 1:3] %*% diag(pca_all$sdev, 3, 3)
...
unweighted_scores <- as.matrix(scaled_data) %*% pca_all$rotation[, 1:3]
...
weighted_scores <- unweighted_scores %*% variance_exp$proportion_variance[1:3]
...
write.csv(index_result, "Preparedness_index.csv")
