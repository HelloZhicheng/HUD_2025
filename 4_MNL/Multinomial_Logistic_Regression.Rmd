...
Description: "This script performs multinomial logistic regression using the `glmnet` package, including data splitting, 
hyperparameter tuning, model evaluation, and bootstrap resampling for coefficient uncertainty estimation."
---
...
# Replace "cluster_weighted_0617_3cluster_mean.csv" with the correct path to your dataset.
