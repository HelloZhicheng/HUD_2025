...
Input: "rescaled_index_0610.xlsx` (data with vulnerability and resilience indices)"
...
rescaled_index_rank <- read_excel("rescaled_index_0610.xlsx")
```
...
# Save results to CSV
write.csv(data_with_clusters, "cluster_weighted_0617_3cluster_mean.csv", row.names = FALSE)
```
